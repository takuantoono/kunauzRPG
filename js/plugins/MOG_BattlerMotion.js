...
Game_Action.prototype.prepare = function() {	
	...
	if(!this.subject()._bdame&&this.subject()._bstop){
	if(this.subject()._motion_action_data[1] < 15)this.subject()._bstop=false
	}
...
if(this._motion_action_data && !this._bstop) return;
...
Sprite_Battler.prototype.set_breath_mode = function() {
		this._battler._motion_breath = [0,0,0,1.01,2,true];
...
Sprite_Battler.prototype.update_idle_breath_mode = function() {
	    this._battler._motion_breath[2] += 0.5
...
if(this._battler._bstop&&this._battler._bstop)return
      this._battler._motion_action_data[1] += 1
	  if (this._battler._motion_action_data[1] < 10) {
		  this._battler._motion_action_scale[0] = -2.00; 
		  this._battler._motion_action_xy[0] -= 6;
...
if(this._battler._bstop)return
      this._battler._motion_action_data[1] += 1
