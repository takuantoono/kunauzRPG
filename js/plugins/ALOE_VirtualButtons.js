...
(function () {
  ...
  Sprite_DirectionalPad.prototype.whichIndex = function (point) {
    ...
    if(SceneManager._scene.constructor==Scene_Battle){
    index = 0;
    if(point.x>this.x+50&&point.x<this.x+100&&point.y>this.y+50&&point.y<this.y+100){
    }else{
    ...
    if(SceneManager._scene.constructor==Scene_Skill||SceneManager._scene.constructor==Scene_Equip){
