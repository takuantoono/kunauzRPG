...
(function() {
    ...
    if(!this._subject) return;
        ...
        if(action.isForOne() && BattleManager.gancai&&BattleManager._dualWieldTargetsN){
        console.log(this._subject)
        this._dualWieldTargets = BattleManager._dualWieldTargetsN;
        }else{
    ...
    BattleManager._dualWieldTargetsN = repeatedTargets;
    var repeatedTargets = [];
