...
Game_Action.prototype.isInsideAoeCircle = function(main, target) {
    ...
    if(skill.meta.RainR&&$gameSwitches.value(8)&&$gameSwitches.value(13)&&!$gameSwitches.value(420)){
    radius*=5
    }
    if (mainX > targetX) {
...
Sprite_AoeCircle.prototype.setup = function(skill) {
    ...
    if(this._skill.meta.RainR&&$gameSwitches.value(8)&&$gameSwitches.value(13)){
    this._radius*=5
    }
    this.show();
    this.createBitmap();
